...
print(service.readParameter(NPB1700Commands.FAULT_STATUS))
print(service.readParameter(NPB1700Commands.CHG_STATUS))
...
print(service.readParameter(NPB1700Commands.CURVE_CC))
print(service.readParameter(NPB1700Commands.CURVE_CV))
print(service.readParameter(NPB1700Commands.CURVE_FV))
