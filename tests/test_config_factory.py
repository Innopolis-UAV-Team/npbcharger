...
from NPB_1700.parsers.factories.config_factory import ConfigParserFactory, FieldType
...
class TestConfigFactory(unittest.TestCase):
    ...
    def test_field_parsing(self):
        ...
        msg = Message(data=bytearray([0x00, 0x00]) + bytearray(test_value.to_bytes(2, "little")))
