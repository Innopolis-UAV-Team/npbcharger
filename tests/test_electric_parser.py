...
from NPB_1700.parsers.electricData import ElectricDataParser
...
class TestElectricDataParser(unittest.TestCase):
    ...
    def test_parse_read_voltage(self):
        ...
        result = self.parser.parseRead(msg)
    ...
    def test_parse_write_rounding(self):
        result = self.parser.parseWrite(21.567)
