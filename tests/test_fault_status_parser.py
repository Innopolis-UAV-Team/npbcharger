...
class TestFaultStatusParser(unittest.TestCase):
    ...
    def test_common_fault_scenarios(self):
        ...
        test_cases = [
            ...
            ("Over Temperature", FaultStatus.OTP.value, ["Over Temperature Protection"], True, False),
            ("Output Disabled", FaultStatus.OP_OFF.value, ["Output Disabled"], False, False),
            ("Over Voltage", FaultStatus.OVP.value, ["Over Voltage Protection"], True, False),
